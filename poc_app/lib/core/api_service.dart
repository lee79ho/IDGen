...
class ApiService {
  ...
  /// sending the current app version and returning the update status and a splash image URL.
  ///
  /// For this POC, it randomly returns one of the [UpdateStatus] values
  /// and a dummy image URL after a short delay to mimic network latency.
  Future<AppVersionInfo> checkAppVersion() async {
    // Simulate network latency
    await Future.delayed(const Duration(seconds: 1));

    // Dummy image URL
    const String dummyImageUrl = 'https://via.placeholder.com/300';
    ...
    return AppVersionInfo(status, dummyImageUrl);
  }
}
